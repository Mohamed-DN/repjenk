...
// ACME S.p.A. — Gestione connessioni e esecuzione SQL/PL/SQL
// =============================================================================
...
private def executeWithWallet(Map dbConfig, String credId, String sqlTool, Closure sqlAction) {
    ...
    def walletDir = "/tmp/acme_wallet_${System.currentTimeMillis()}_${UUID.randomUUID().toString().substring(0,8)}"
