...
# ===========================================================================
log_info "============================================================"
log_info " DARKNERO Data Pump Import — Avvio"
...
build_impdp_command() {
    ...
    # Job name univoco
    local job_name="DN_IMP_${SCHEMA}_${TIMESTAMP}"
...
generate_parfile() {
    ...
    PARFILE_PATH="${parfile_dir}/dn_impdp_${SCHEMA}_${TIMESTAMP}.par"

    log_info "Generazione parfile: ${PARFILE_PATH}"

    cat > "${PARFILE_PATH}" <<PAREOF
# =============================================================================
# DARKNERO Data Pump Import — Parfile generato automaticamente
# Schema: ${SCHEMA}
