...
# ===========================================================================
log_info "============================================================"
log_info " DARKNERO Data Pump Export — Avvio"
...
build_expdp_command() {
    ...
    # Job name univoco
    local job_name="DN_EXP_${SCHEMA}_${TIMESTAMP}"
...
generate_parfile() {
    ...
    PARFILE_PATH="${parfile_dir}/dn_expdp_${SCHEMA}_${TIMESTAMP}.par"

    log_info "Generazione parfile: ${PARFILE_PATH}"

    cat > "${PARFILE_PATH}" <<PAREOF
# =============================================================================
# DARKNERO Data Pump Export — Parfile generato automaticamente
# Schema: ${SCHEMA}
